package net.paulacr.starwars.activities;
...
import net.paulacr.starwars.fragments.PeopleListFragment;
...
public class PeopleListActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    private void changeFragment(Fragment fragment) {
        ...
        transaction.replace(R.id.people_content_frame, fragment);
